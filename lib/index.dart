...
export '/pages/onboarding_login/goals/goals_widget.dart' show GoalsWidget;
...
export '/pages/progress_tracker/progress_tracker_widget.dart'
    show ProgressTrackerWidget;
export '/pages/main_pages/home_copy/home_copy_widget.dart' show HomeCopyWidget;
export '/completar_info/completar_info_widget.dart' show CompletarInfoWidget;
