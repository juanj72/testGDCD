...
class CableWidget extends StatefulWidget {
  const CableWidget({Key? key}) : super(key: key);

  @override
  _CableWidgetState createState() => _CableWidgetState();
}

class _CableWidgetState extends State<CableWidget>
    with TickerProviderStateMixin {
  late CableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CableModel());
